      ...
      <div className=" w-full h-10 flex items-center justify-between  gap-5 p-2 border border-slate-blue rounded-xl mt-3 overflow-clip font-open">
        {tag !== "Location" ? (
          <DatePicker
            ...
            className="placeholder:text-xs text-slate-blue placeholder:font-open w-full h-full bg-transparent outline-none"
          ...
          <input
            ...
            className=" placeholder:text-xs  placeholder:font-open w-full h-full bg-transparent outline-none"
          />
        )}
